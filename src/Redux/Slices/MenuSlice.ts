...
import { fetchMenu } from "../Thunks/MenuThunk";
...
const menuSlice = createSlice({
  ...
  reducers: {
    ...
    setSelectedMenuSubItem(state, action: PayloadAction<number>) {
      state.selectedSubItemIndex = action.payload;
    },
  },
...
export const { setSelectedMenuItem, setSelectedMenuSubItem } =
  menuSlice.actions;
